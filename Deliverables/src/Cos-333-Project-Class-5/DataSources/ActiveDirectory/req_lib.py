...
https://github.com/vr2amesh/COS333-API-Code-Examples/blob/master/ActiveDirectory/python/req_lib.py 
Accessed 10/15/2020. """

#!/usr/bin/env python3
import requests
import json
from DataSources.ActiveDirectory.configs import Configs
