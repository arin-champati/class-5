...
(function($) {
  ...
  $.fn.areYouSure = function(options) {
    ...
    // *** CLASS 5 ORIGINAL CODE
    //   if we click on a navbar link, don't let the user leave if the form is unsaved
    $( "nav.navbar" ).on("click", "a", function(e) {
      // don't handle when we click the dropdown toggle button
      if($(e.target).is("a.dropdown-toggle")) return;
      ...
      if ($dirtyForms.length != 0) {
          ...
          // then we need to prevent the before unload handler from happening
